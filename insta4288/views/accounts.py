...
URLs:
    ...
    POST /accounts/                 -> handle login (operation=login)
    POST /accounts/logout/          -> handle logout
    (optional) GET /accounts/       -> redirect to /accounts/login/
"""
import flask
import insta4288
...
def accounts_logout():
    ...
    target = flask.request.args.get("target", flask.url_for("accounts_login_page"))
