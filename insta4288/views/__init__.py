...
from insta4288.views.accounts import (accounts_login_page,
                                      accounts_get_redirect,
                                      accounts_logout)
from insta4288.views.accounts_create import accounts_create
from insta4288.views.accounts_manage import (accounts_delete,
                                             accounts_edit,
                                             accounts_password,
                                             accounts_auth)
from insta4288.views.actions import (update_likes,
                                     update_comments,
                                     update_posts,
                                     update_following,
                                     accounts_ops)
